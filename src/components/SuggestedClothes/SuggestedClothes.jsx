...
const SuggestedClothes = ({ weatherCategory, styleFilter }) => {

    return (
        <div className={styles['suggested-clothes-container']}>
            <div className={styles['category-label']}>Tops</div>
            <SuggestedCategoryItems clothingCategory={'tops'} weatherCategory={weatherCategory} styleFilter={styleFilter} />
            <div className={styles['category-label']}>Bottoms</div>
            <SuggestedCategoryItems clothingCategory={'bottoms'} weatherCategory={weatherCategory} styleFilter={styleFilter} />
            <div className={styles['category-label']}>Outerwear</div>
            <SuggestedCategoryItems clothingCategory={'outerwear'} weatherCategory={weatherCategory} styleFilter={styleFilter} />
        </div>
    );
}
